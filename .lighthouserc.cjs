  ...
  ci: {
    ...
    assert: {
      assertions: {
        ...
        'html-has-lang': ['error', { minScore: 1, aggregationMethod: 'median' }],
        viewport: ['error', { minScore: 1, aggregationMethod: 'median' }],
