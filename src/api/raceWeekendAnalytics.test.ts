  ...
  it('builds telemetry summaries and tolerates empty samples', () => {
    expect(buildDriverTelemetrySummary({
      ...
      samples: {
        distanceM: [0, 100, 200],
        timeSeconds: [0, 4, 8],
        speedKph: [120, 300, null],
        rpm: [10000, 12000, null],
        gear: [3, 8, null],
        throttlePct: [100, 80, null],
        brake: [false, true, false],
        drs: [12, 0, null],
      },
      positionSamples: { distanceM: [], x: [], y: [], z: [], speedKph: [] },
    })).toMatchObject({
      maxSpeedKph: 300,
      avgSpeedKph: 210,
      fullThrottlePct: 50,
    ...
    expect(buildDriverTelemetrySummary({
      ...
      lapTimeSeconds: null,
      compound: 'UNKNOWN',
      samples: { distanceM: [], timeSeconds: [], speedKph: [], rpm: [], gear: [], throttlePct: [], brake: [], drs: [] },
      positionSamples: { distanceM: [], x: [], y: [], z: [], speedKph: [] },
    })).toMatchObject({
      maxSpeedKph: null,
      avgSpeedKph: null,
